...
fs.mkdirSync('app/api/rounds/current', { recursive: true })

const currentRound = `import { NextResponse } from "next/server"
...
fs.writeFileSync('app/api/rounds/current/route.ts', currentRound)
console.log('Gata!')