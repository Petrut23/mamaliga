  ...
  return (
    <nav className="bg-[#111520] border-b border-[#1e2640] px-4 md:px-6 h-14 flex items-center justify-between sticky top-0 z-50">
      ...
      <div className="flex items-center gap-1 md:gap-3">
        ...
        {isAdmin && (
          <Link href="/admin" className={"text-xs md:text-sm font-bold px-2 md:px-3 py-1.5 rounded-lg border transition-colors " + (pathname?.startsWith("/admin") ? "bg-[#e8ff47] text-black border-[#e8ff47]" : "text-[#e8ff47] border-[#e8ff47]/40 bg-[#e8ff47]/10 hover:bg-[#e8ff47]/20")}>
