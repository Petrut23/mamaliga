...
fs.mkdirSync('app/rezultate', { recursive: true })
fs.mkdirSync('app/api/rezultate', { recursive: true })

const rezultateApi = `import { NextRequest, NextResponse } from "next/server"
...
const rezultatePage = `"use client"
...
fs.writeFileSync('app/api/rezultate/route.ts', rezultateApi)
fs.writeFileSync('app/rezultate/page.tsx', rezultatePage)
console.log('Gata!')