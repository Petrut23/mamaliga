...
fs.mkdirSync('app/admin/utilizatori', { recursive: true })
fs.mkdirSync('app/api/admin/utilizatori', { recursive: true })

const utilizatoriApi = `import { NextRequest, NextResponse } from "next/server"
...
const utilizatoriPage = `"use client"
...
fs.writeFileSync('app/admin/utilizatori/page.tsx', utilizatoriPage)
console.log('Gata!')