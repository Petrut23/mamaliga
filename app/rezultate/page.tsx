...
export default function RezultatePage() {
  ...
  const bestRound = rounds.reduce((best: any, r) => r.totalPoints > (best?.totalPoints || 0) ? r : best, null)
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="bg-[#0a0d14] rounded-full h-2">
                      <div className="bg-green-400 h-2 rounded-full" style={{width: Math.round(stats.exact/stats.total*100) + "%"}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                    ...
                    <div className="bg-[#0a0d14] rounded-full h-2">
                      <div className="bg-yellow-400 h-2 rounded-full" style={{width: Math.round(stats.diff/stats.total*100) + "%"}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                    ...
                    <div className="bg-[#0a0d14] rounded-full h-2">
                      <div className="bg-blue-400 h-2 rounded-full" style={{width: Math.round(stats.result/stats.total*100) + "%"}}></div>
                    </div>
                  </div>
                  <div>
                    <div className="flex justify-between text-xs mb-1">
                    ...
                    <div className="bg-[#0a0d14] rounded-full h-2">
                      <div className="bg-red-400 h-2 rounded-full" style={{width: Math.round(stats.wrong/stats.total*100) + "%"}}></div>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {[...rounds].reverse().map((r: any) => {
                    ...
                    return (
                      <div key={r.id} className="flex-1 flex flex-col items-center gap-1">
                        ...
                        <div className="w-full rounded-t-lg" style={{height: height + "%", minHeight: "4px", backgroundColor: r.id === bestRound?.id ? "#e8ff47" : "rgba(232,255,71,0.3)"}}></div>
