...
fs.mkdirSync('app/live', { recursive: true })
fs.mkdirSync('app/api/live', { recursive: true })
        ...
        {activeTab === "meciuri" && (
          <div className="space-y-3">
            {data.matches.map((meci: any) => (
              <div key={meci.id} className={"rounded-xl border px-4 py-3 " + (meci.status === "LIVE" || meci.status === "HALFTIME" ? "bg-red-500/05 border-red-500/20" : meci.status === "FINISHED" ? "bg-[#111520] border-[#1e2640] opacity-75" : "bg-[#111520] border-[#1e2640]")}>
